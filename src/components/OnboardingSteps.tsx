    ...
    <div className="mb-8 rounded-2xl border border-ig-border bg-ig-secondary p-5">
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        <a
          ...
          className={`flex items-start gap-3 rounded-xl border px-4 py-3 transition ${
            activeStep === 1
              ...
              : step1Done
                ? "border-ig-success/30 bg-emerald-500/5"
                : "border-ig-border bg-ig-elevated hover:bg-ig-secondary"
          }`}
        >
          <div
            className={`mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-full ${
              step1Done ? "bg-emerald-500/20 text-ig-success" : "bg-ig-primary/20 text-ig-link"
            }`}
          >
          ...
          <div>
            <p className="text-sm font-semibold text-ig-text">
              1. Treinar IA
              {step1Done && <span className="ml-2 text-xs font-normal text-ig-success">Pronto</span>}
            </p>
        ...
        >
          <div
            className={`mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-full ${
              step2Done ? "bg-emerald-500/20 text-ig-success" : "bg-ig-primary/20 text-ig-link"
            }`}
          >
          ...
          <div>
            <p className="text-sm font-semibold text-ig-text">
              2. Enviar vídeos
              {step2Done && <span className="ml-2 text-xs font-normal text-ig-success">Feito</span>}
            </p>
            <p className="mt-1 text-xs text-ig-muted">
