...
import { buildUploadBatchDiagnostics } from "@/lib/upload/admin-diagnostics";
...
/** Diagnóstico de upload por lote (admin). */
export async function POST(request: NextRequest) {
  ...
  const result = await buildUploadBatchDiagnostics(
    supabase,
    sessionOwnerId,
    parsed.data.batchId,
    parsed.data.fileId,
